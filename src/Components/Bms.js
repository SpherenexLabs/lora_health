...
export default function App() {
  ...
  // Only use the latest value; omit the series to avoid unused var warnings
  const { latest: batteryPct } = useSawtoothSeries({ min: 95, max: 97 });
...
// (Removed unused MetricCard component to satisfy linter)
...
// (Removed unused TrendBadge helper to satisfy linter)
